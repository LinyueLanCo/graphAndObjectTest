...
enum AnimationState
{
	...
	ANIM_CHECKPOINT_NO_FLAG,
	ANIM_CHECKPOINT_FLAG_OUT,
	ANIM_CHECKPOINT_FLAG_IDLE,

	ANIM_ENDPOINT_IDLE,
	ANIM_ENDPOINT_PRESSED,
...
enum AnimationId
{
	...
	ANIM_ID_CHECKPOINT_NO_FLAG,
	ANIM_ID_CHECKPOINT_FLAG_OUT,
	ANIM_ID_CHECKPOINT_FLAG_IDLE,

	

	ANIM_ID_ENDPOINT_IDLE,
	ANIM_ID_ENDPOINT_PRESSED,
